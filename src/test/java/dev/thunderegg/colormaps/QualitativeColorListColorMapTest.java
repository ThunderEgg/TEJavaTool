...
public class QualitativeColorListColorMapTest {

        @Test
        public void emptyListThrows() {
                List<Color> list = Arrays.asList();

                assertThrows(IllegalArgumentException.class, () -> new QualitativeColorListColorMap("name", list));
        }
        ...
        public void getColorNeg1() {
                ...
                QualitativeColorListColorMap map = new QualitativeColorListColorMap("name", list);
        ...
        public void getName() {
                ...
                QualitativeColorListColorMap map = new QualitativeColorListColorMap("blah", list);
