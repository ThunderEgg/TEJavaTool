...
/**
 * Colormaps from matplotlib python library taken from
 * 
 ...
 * works, distribute, and otherwise use matplotlib alone or in any derivative
 ...
 * 
 * 5. MDT SHALL NOT BE LIABLE TO LICENSEE OR ANY OTHER USERS OF MATPLOTLIB FOR
 ...
 * 
 * 8. By copying, installing or otherwise using matplotlib , Licensee agrees to
 ...
 * copyright, i.e., "Copyright (c) 2002-2011 John D. Hunter; All Rights
 * Reserved" are retained in matplotlib alone or in any derivative version
 * prepared by Licensee.
 * 
 * 3. In the event Licensee prepares a derivative work that is based on or
 ...
 * include in any such work a brief summary of the changes made to matplotlib.
 * 
 * 4. JDH is making matplotlib available to Licensee on an "AS IS" basis. JDH
 * MAKES NO REPRESENTATIONS OR WARRANTIES, EXPRESS OR IMPLIED. BY WAY OF
 * EXAMPLE, BUT NOT LIMITATION, JDH MAKES NO AND DISCLAIMS ANY REPRESENTATION OR
 * WARRANTY OF MERCHANTABILITY OR FITNESS FOR ANY PARTICULAR PURPOSE OR THAT THE
 * USE OF MATPLOTLIB WILL NOT INFRINGE ANY THIRD PARTY RIGHTS.
 * 
 * 5. JDH SHALL NOT BE LIABLE TO LICENSEE OR ANY OTHER USERS OF MATPLOTLIB FOR
 * ANY INCIDENTAL, SPECIAL, OR CONSEQUENTIAL DAMAGES OR LOSS AS A RESULT OF
 * MODIFYING, DISTRIBUTING, OR OTHERWISE USING MATPLOTLIB , OR ANY DERIVATIVE
 * THEREOF, EVEN IF ADVISED OF THE POSSIBILITY THEREOF.
 * 
