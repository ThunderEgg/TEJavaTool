 ...
 */
class ColorMaps {
        public static ColorMap binary = new ListColorMap(Arrays.asList(new Point(0., 1., 1.), new Point(1., 0., 0.)),
                        Arrays.asList(new Point(0., 1., 1.), new Point(1., 0., 0.)),
                        Arrays.asList(new Point(0., 1., 1.), new Point(1., 0., 0.)));

        public static ColorMap autumn = new ListColorMap(
                        Arrays.asList(new Point(0., 1.0, 1.0), new Point(1.0, 1.0, 1.0)),
                        Arrays.asList(new Point(0., 0., 0.), new Point(1.0, 1.0, 1.0)),
                        Arrays.asList(new Point(0., 0., 0.), new Point(1.0, 0., 0.)));

        public static ColorMap bone = new ListColorMap(
                        Arrays.asList(new Point(0., 0., 0.), new Point(0.746032, 0.652778, 0.652778),
                                        new Point(1.0, 1.0, 1.0)),
                        Arrays.asList(new Point(0., 0., 0.), new Point(0.365079, 0.319444, 0.319444),
                                        new Point(0.746032, 0.777778, 0.777778), new Point(1.0, 1.0, 1.0)),
                        Arrays.asList(new Point(0., 0., 0.), new Point(0.365079, 0.444444, 0.444444),
                                        new Point(1.0, 1.0, 1.0)));

        public static ColorMap cool = new ListColorMap(Arrays.asList(new Point(0., 0., 0.), new Point(1.0, 1.0, 1.0)),
                        Arrays.asList(new Point(0., 1., 1.), new Point(1.0, 0., 0.)),
                        Arrays.asList(new Point(0., 1., 1.), new Point(1.0, 1., 1.)));

        public static ColorMap copper = new ListColorMap(
                        Arrays.asList(new Point(0., 0., 0.), new Point(0.809524, 1.000000, 1.000000),
                                        new Point(1.0, 1.0, 1.0)),
                        Arrays.asList(new Point(0., 0., 0.), new Point(1.0, 0.7812, 0.7812)),
                        Arrays.asList(new Point(0., 0., 0.), new Point(1.0, 0.4975, 0.4975)));
        ...
        public static ColorMap flag = new FunctionColorMap(ColorMaps::flag_red, ColorMaps::flag_green,
                        ColorMaps::flag_blue);
        ...
        public static ColorMap prism = new FunctionColorMap(ColorMaps::prism_red, ColorMaps::prism_green,
        ...
        private static ColorMap cubehelix_function(double gamma, double s, double r, double h) {
                return new FunctionColorMap((double x) -> ch_helper(gamma, s, r, h, -0.14861, 1.78277, x),
        ...
        public static ColorMap bwr = new ColorListColorMap(Arrays.asList(new Color(0.0, 0.0, 1.0, 1.0),
                        new Color(1.0, 1.0, 1.0, 1.0), new Color(1.0, 0.0, 0.0, 1.0)));
        public static ColorMap brg = new ColorListColorMap(Arrays.asList(new Color(0.0, 0.0, 1.0, 1.0),
        ...
        public static ColorMap gnuplot = new FunctionColorMap(ColorMaps::g7, ColorMaps::g5, ColorMaps::g15);

        public static ColorMap gnuplot2 = new FunctionColorMap(ColorMaps::g30, ColorMaps::g31, ColorMaps::g32);

        public static ColorMap ocean = new FunctionColorMap(ColorMaps::g23, ColorMaps::g28, ColorMaps::g3);

        public static ColorMap afmhot = new FunctionColorMap(ColorMaps::g34, ColorMaps::g35, ColorMaps::g36);

        public static ColorMap rainbow = new FunctionColorMap(ColorMaps::g33, ColorMaps::g13, ColorMaps::g10);

        public static ColorMap seismic = new ColorListColorMap(Arrays.asList(new Color(0.0, 0.0, 0.3, 1.0),
                        new Color(0.0, 0.0, 1.0, 1.0), new Color(1.0, 1.0, 1.0, 1.0), new Color(1.0, 0.0, 0.0, 1.0),
                        new Color(0.5, 0.0, 0.0, 1.0)));

        public static ColorMap terrain = new RGBPointListColorMap(
        ...
        public static ColorMap gray = new ListColorMap(Arrays.asList(new Point(0., 0, 0), new Point(1., 1, 1)),
                        Arrays.asList(new Point(0., 0, 0), new Point(1., 1, 1)),
                        Arrays.asList(new Point(0., 0, 0), new Point(1., 1, 1)));

        public static ColorMap hot = new ListColorMap(
                        Arrays.asList(new Point(0., 0.0416, 0.0416), new Point(0.365079, 1.000000, 1.000000),
                                        new Point(1.0, 1.0, 1.0)),
                        Arrays.asList(new Point(0., 0., 0.), new Point(0.365079, 0.000000, 0.000000),
                                        new Point(0.746032, 1.000000, 1.000000), new Point(1.0, 1.0, 1.0)),
                        Arrays.asList(new Point(0., 0., 0.), new Point(0.746032, 0.000000, 0.000000),
                                        new Point(1.0, 1.0, 1.0)));

        public static ColorMap hsv = new ListColorMap(Arrays.asList(new Point(0., 1., 1.),
                        new Point(0.158730, 1.000000, 1.000000), new Point(0.174603, 0.968750, 0.968750),
                        new Point(0.333333, 0.031250, 0.031250), new Point(0.349206, 0.000000, 0.000000),
                        new Point(0.666667, 0.000000, 0.000000), new Point(0.682540, 0.031250, 0.031250),
                        new Point(0.841270, 0.968750, 0.968750), new Point(0.857143, 1.000000, 1.000000),
                        new Point(1.0, 1.0, 1.0)),
                        Arrays.asList(new Point(0., 0., 0.), new Point(0.158730, 0.937500, 0.937500),
                                        new Point(0.174603, 1.000000, 1.000000),
                                        new Point(0.507937, 1.000000, 1.000000),
                                        new Point(0.666667, 0.062500, 0.062500),
                                        new Point(0.682540, 0.000000, 0.000000), new Point(1.0, 0., 0.)),
                        Arrays.asList(new Point(0., 0., 0.), new Point(0.333333, 0.000000, 0.000000),
                                        new Point(0.349206, 0.062500, 0.062500),
                                        new Point(0.507937, 1.000000, 1.000000),
                                        new Point(0.841270, 1.000000, 1.000000),
                                        new Point(0.857143, 0.937500, 0.937500), new Point(1.0, 0.09375, 0.09375)));

        public static ColorMap jet = new ListColorMap(
                        Arrays.asList(new Point(0.00, 0, 0), new Point(0.35, 0, 0), new Point(0.66, 1, 1),
                                        new Point(0.89, 1, 1), new Point(1.00, 0.5, 0.5)),
                        Arrays.asList(new Point(0.000, 0, 0), new Point(0.125, 0, 0), new Point(0.375, 1, 1),
                                        new Point(0.640, 1, 1), new Point(0.910, 0, 0), new Point(1.000, 0, 0)),
                        Arrays.asList(new Point(0.00, 0.5, 0.5), new Point(0.11, 1, 1), new Point(0.34, 1, 1),
                                        new Point(0.65, 0, 0), new Point(1.00, 0, 0)));

        public static ColorMap pink = new ListColorMap(Arrays.asList(new Point(0., 0.1178, 0.1178),
                        new Point(0.015873, 0.195857, 0.195857), new Point(0.031746, 0.250661, 0.250661),
                        new Point(0.047619, 0.295468, 0.295468), new Point(0.063492, 0.334324, 0.334324),
                        new Point(0.079365, 0.369112, 0.369112), new Point(0.095238, 0.400892, 0.400892),
                                        new Point(0.428571, 0.534522, 0.534522),
                                        new Point(0.444444, 0.544331, 0.544331),
                                        new Point(0.460317, 0.553966, 0.553966),
                                        new Point(0.476190, 0.563436, 0.563436),
                                        new Point(0.492063, 0.572750, 0.572750),
                                        new Point(0.507937, 0.581914, 0.581914),
                                        new Point(0.523810, 0.590937, 0.590937),
                                        new Point(0.539683, 0.599824, 0.599824),
                                        new Point(0.555556, 0.608581, 0.608581),
                                        new Point(0.571429, 0.617213, 0.617213),
                                        new Point(0.587302, 0.625727, 0.625727),
                                        new Point(0.603175, 0.634126, 0.634126),
                                        new Point(0.619048, 0.642416, 0.642416),
                                        new Point(0.634921, 0.650600, 0.650600),
                                        new Point(0.650794, 0.658682, 0.658682),
                                        new Point(0.666667, 0.666667, 0.666667),
                                        new Point(0.682540, 0.674556, 0.674556),
                                        new Point(0.698413, 0.682355, 0.682355),
                                        new Point(0.714286, 0.690066, 0.690066),
                                        new Point(0.730159, 0.697691, 0.697691),
                                        new Point(0.746032, 0.705234, 0.705234),
                                        new Point(0.761905, 0.727166, 0.727166),
                                        new Point(0.777778, 0.748455, 0.748455),
                                        new Point(0.793651, 0.769156, 0.769156),
                                        new Point(0.809524, 0.789314, 0.789314),
                                        new Point(0.825397, 0.808969, 0.808969),
                                        new Point(0.841270, 0.828159, 0.828159),
                                        new Point(0.857143, 0.846913, 0.846913),
                                        new Point(0.873016, 0.865261, 0.865261),
                                        new Point(0.888889, 0.883229, 0.883229),
                                        new Point(0.904762, 0.900837, 0.900837),
                                        new Point(0.920635, 0.918109, 0.918109),
                                        new Point(0.936508, 0.935061, 0.935061),
                                        new Point(0.952381, 0.951711, 0.951711),
                                        new Point(0.968254, 0.968075, 0.968075),
                                        new Point(0.984127, 0.984167, 0.984167), new Point(1.0, 1.0, 1.0)));

        public static ColorMap spring = new ListColorMap(Arrays.asList(new Point(0., 1., 1.), new Point(1.0, 1.0, 1.0)),
                        Arrays.asList(new Point(0., 0., 0.), new Point(1.0, 1.0, 1.0)),
                        Arrays.asList(new Point(0., 1., 1.), new Point(1.0, 0.0, 0.0)));

        public static ColorMap summer = new ListColorMap(Arrays.asList(new Point(0., 0., 0.), new Point(1.0, 1.0, 1.0)),
                        Arrays.asList(new Point(0., 0.5, 0.5), new Point(1.0, 1.0, 1.0)),
                        Arrays.asList(new Point(0., 0.4, 0.4), new Point(1.0, 0.4, 0.4)));

        public static ColorMap winter = new ListColorMap(Arrays.asList(new Point(0., 0., 0.), new Point(1.0, 0.0, 0.0)),
                        Arrays.asList(new Point(0., 0., 0.), new Point(1.0, 1.0, 1.0)),
                        Arrays.asList(new Point(0., 1., 1.), new Point(1.0, 0.5, 0.5)));

        public static ColorMap nipy_spectral = new ListColorMap(Arrays.asList(new Point(0.0, 0.0, 0.0),
                        new Point(0.05, 0.4667, 0.4667), new Point(0.10, 0.5333, 0.5333), new Point(0.15, 0.0, 0.0),
                        new Point(0.20, 0.0, 0.0), new Point(0.25, 0.0, 0.0), new Point(0.30, 0.0, 0.0),
                        new Point(0.35, 0.0, 0.0), new Point(0.40, 0.0, 0.0), new Point(0.45, 0.0, 0.0),
                        new Point(0.50, 0.0, 0.0), new Point(0.55, 0.0, 0.0), new Point(0.60, 0.0, 0.0),
                        new Point(0.65, 0.7333, 0.7333), new Point(0.70, 0.9333, 0.9333), new Point(0.75, 1.0, 1.0),
                        new Point(0.80, 1.0, 1.0), new Point(0.85, 1.0, 1.0), new Point(0.90, 0.8667, 0.8667),
                        new Point(0.95, 0.80, 0.80), new Point(1.0, 0.80, 0.80)),
                        Arrays.asList(new Point(0.0, 0.0, 0.0), new Point(0.05, 0.0, 0.0), new Point(0.10, 0.0, 0.0),
                                        new Point(0.15, 0.0, 0.0), new Point(0.20, 0.0, 0.0),
                                        new Point(0.25, 0.4667, 0.4667), new Point(0.30, 0.6000, 0.6000),
                                        new Point(0.35, 0.6667, 0.6667), new Point(0.40, 0.6667, 0.6667),
                                        new Point(0.45, 0.6000, 0.6000), new Point(0.50, 0.7333, 0.7333),
                                        new Point(0.55, 0.8667, 0.8667), new Point(0.60, 1.0, 1.0),
                                        new Point(0.65, 1.0, 1.0), new Point(0.70, 0.9333, 0.9333),
                                        new Point(0.75, 0.8000, 0.8000), new Point(0.80, 0.6000, 0.6000),
                                        new Point(0.85, 0.0, 0.0), new Point(0.90, 0.0, 0.0), new Point(0.95, 0.0, 0.0),
                                        new Point(1.0, 0.80, 0.80)),
                        Arrays.asList(new Point(0.0, 0.0, 0.0), new Point(0.05, 0.5333, 0.5333),
                                        new Point(0.10, 0.6000, 0.6000), new Point(0.15, 0.6667, 0.6667),
                                        new Point(0.20, 0.8667, 0.8667), new Point(0.25, 0.8667, 0.8667),
                                        new Point(0.30, 0.8667, 0.8667), new Point(0.35, 0.6667, 0.6667),
                                        new Point(0.40, 0.5333, 0.5333), new Point(0.45, 0.0, 0.0),
                                        new Point(0.5, 0.0, 0.0), new Point(0.55, 0.0, 0.0), new Point(0.60, 0.0, 0.0),
                                        new Point(0.65, 0.0, 0.0), new Point(0.70, 0.0, 0.0), new Point(0.75, 0.0, 0.0),
                                        new Point(0.80, 0.0, 0.0), new Point(0.85, 0.0, 0.0), new Point(0.90, 0.0, 0.0),
                                        new Point(0.95, 0.0, 0.0), new Point(1.0, 0.80, 0.80)));
         ...
         */
        public static ColorMap Blues = new ColorListColorMap(
        ...
        public static ColorMap BrBG = new ColorListColorMap(
        ...
        public static ColorMap BuGn = new ColorListColorMap(
        ...
        public static ColorMap BuPu = new ColorListColorMap(
                        Arrays.asList(new Color(0.96862745098039216, 0.9882352941176471, 0.99215686274509807, 1.0),
        ...
        public static ColorMap GnBu = new ColorListColorMap(
        ...
        public static ColorMap Greens = new ColorListColorMap(
        ...
        public static ColorMap Greys = new ColorListColorMap(Arrays.asList(new Color(1.0, 1.0, 1.0, 1.0),
        ...
        public static ColorMap Oranges = new ColorListColorMap(
        ...
        public static ColorMap OrRd = new ColorListColorMap(Arrays.asList(
                        new Color(1.0, 0.96862745098039216, 0.92549019607843142, 1.0),
                        ...
                        new Color(0.70196078431372544, 0.0, 0.0, 1.0), new Color(0.49803921568627452, 0.0, 0.0, 1.0)));

        public static ColorMap PiYG = new ColorListColorMap(
        ...
        public static ColorMap PRGn = new ColorListColorMap(
        ...
        public static ColorMap PuBu = new ColorListColorMap(
        ...
        public static ColorMap PuBuGn = new ColorListColorMap(
                        Arrays.asList(new Color(1.0, 0.96862745098039216, 0.98431372549019602, 1.0),
        ...
        public static ColorMap PuOr = new ColorListColorMap(
        ...
        public static ColorMap PuRd = new ColorListColorMap(
        ...
        public static ColorMap Purples = new ColorListColorMap(
        ...
        public static ColorMap RdBu = new ColorListColorMap(
        ...
        public static ColorMap RdGy = new ColorListColorMap(
                        Arrays.asList(new Color(0.40392156862745099, 0.0, 0.12156862745098039, 1.0),
                                        new Color(0.69803921568627447, 0.09411764705882353, 0.16862745098039217, 1.0),
                                        new Color(0.83921568627450982, 0.37647058823529411, 0.30196078431372547, 1.0),
                                        new Color(0.95686274509803926, 0.6470588235294118, 0.50980392156862742, 1.0),
        ...
        public static ColorMap RdPu = new ColorListColorMap(
        ...
        public static ColorMap RdYlBu = new ColorListColorMap(
        ...
        public static ColorMap RdYlGn = new ColorListColorMap(
                        Arrays.asList(new Color(0.6470588235294118, 0.0, 0.14901960784313725, 1.0),
                                        new Color(0.84313725490196079, 0.18823529411764706, 0.15294117647058825, 1.0),
                                        new Color(0.95686274509803926, 0.42745098039215684, 0.2627450980392157, 1.0),
                                        new Color(0.99215686274509807, 0.68235294117647061, 0.38039215686274508, 1.0),
        ...
        public static ColorMap Reds = new ColorListColorMap(
        ...
        public static ColorMap Spectral = new ColorListColorMap(
        ...
        public static ColorMap YlGn = new ColorListColorMap(Arrays.asList(new Color(1.0, 1.0, 0.89803921568627454, 1.0),
        ...
        public static ColorMap YlGnBu = new ColorListColorMap(
        ...
        public static ColorMap YlOrBr = new ColorListColorMap(
        ...
        public static ColorMap YlOrRd = new ColorListColorMap(Arrays.asList(new Color(1.0, 1.0, 0.8, 1.0),
        ...
        public static ColorMap Accent = new ColorListColorMap(
        ...
        public static ColorMap Dark2 = new ColorListColorMap(
        ...
        public static ColorMap Paired = new ColorListColorMap(
        ...
        public static ColorMap Pastel1 = new ColorListColorMap(
        ...
        public static ColorMap Pastel2 = new ColorListColorMap(Arrays.asList(
                        new Color(0.70196078431372544, 0.88627450980392153, 0.80392156862745101, 1.0),
                        ...
                        new Color(0.94509803921568625, 0.88627450980392153, 0.8, 1.0), new Color(0.8, 0.8, 0.8, 1.0)));

        public static ColorMap Set1 = new ColorListColorMap(
        ...
        public static ColorMap Set2 = new ColorListColorMap(
        ...
        public static ColorMap Set3 = new ColorListColorMap(
         ...
         * effort.
         */
        public static ColorMap gist_earth = new ListColorMap(
                        Arrays.asList(new Point(0.0, 0.0, 0.0000), new Point(0.2824, 0.1882, 0.1882),
                                        new Point(0.4588, 0.2714, 0.2714), new Point(0.5490, 0.4719, 0.4719),
                                        new Point(0.6980, 0.7176, 0.7176), new Point(0.7882, 0.7553, 0.7553),
                                        new Point(1.0000, 0.9922, 0.9922)),
                        Arrays.asList(new Point(0.0, 0.0, 0.0000), new Point(0.0275, 0.0000, 0.0000),
                                        new Point(0.1098, 0.1893, 0.1893), new Point(0.1647, 0.3035, 0.3035),
                                        new Point(0.2078, 0.3841, 0.3841), new Point(0.2824, 0.5020, 0.5020),
                                        new Point(0.5216, 0.6397, 0.6397), new Point(0.6980, 0.7171, 0.7171),
                                        new Point(0.7882, 0.6392, 0.6392), new Point(0.7922, 0.6413, 0.6413),
                                        new Point(0.8000, 0.6447, 0.6447), new Point(0.8078, 0.6481, 0.6481),
                                        new Point(0.8157, 0.6549, 0.6549), new Point(0.8667, 0.6991, 0.6991),
                                        new Point(0.8745, 0.7103, 0.7103), new Point(0.8824, 0.7216, 0.7216),
                                        new Point(0.8902, 0.7323, 0.7323), new Point(0.8980, 0.7430, 0.7430),
                                        new Point(0.9412, 0.8275, 0.8275), new Point(0.9569, 0.8635, 0.8635),
                                        new Point(0.9647, 0.8816, 0.8816), new Point(0.9961, 0.9733, 0.9733),
                                        new Point(1.0000, 0.9843, 0.9843)),
                        Arrays.asList(new Point(0.0, 0.0, 0.0000), new Point(0.0039, 0.1684, 0.1684),
                                        new Point(0.0078, 0.2212, 0.2212), new Point(0.0275, 0.4329, 0.4329),
                                        new Point(0.0314, 0.4549, 0.4549), new Point(0.2824, 0.5004, 0.5004),
                                        new Point(0.4667, 0.2748, 0.2748), new Point(0.5451, 0.3205, 0.3205),
                                        new Point(0.7843, 0.3961, 0.3961), new Point(0.8941, 0.6651, 0.6651),
                                        new Point(1.0000, 0.9843, 0.9843)));

        public static ColorMap gist_gray = new FunctionColorMap(ColorMaps::g3, ColorMaps::g3, ColorMaps::g3);
        ...
        public static ColorMap gist_heat = new FunctionColorMap(ColorMaps::gist_heat_red, ColorMaps::gist_heat_green,
                        ColorMaps::gist_heat_blue);

        public static ColorMap gist_ncar_data = new ListColorMap(
                        Arrays.asList(new Point(0.0, 0.0, 0.0000), new Point(0.3098, 0.0000, 0.0000),
                                        new Point(0.3725, 0.3993, 0.3993), new Point(0.4235, 0.5003, 0.5003),
                                        new Point(0.5333, 1.0000, 1.0000), new Point(0.7922, 1.0000, 1.0000),
                                        new Point(0.8471, 0.6218, 0.6218), new Point(0.8980, 0.9235, 0.9235),
                                        new Point(1.0000, 0.9961, 0.9961)),
                        Arrays.asList(new Point(0.0, 0.0, 0.0000), new Point(0.0510, 0.3722, 0.3722),
                                        new Point(0.1059, 0.0000, 0.0000), new Point(0.1569, 0.7202, 0.7202),
                                        new Point(0.1608, 0.7537, 0.7537), new Point(0.1647, 0.7752, 0.7752),
                                        new Point(0.2157, 1.0000, 1.0000), new Point(0.2588, 0.9804, 0.9804),
                                        new Point(0.2706, 0.9804, 0.9804), new Point(0.3176, 1.0000, 1.0000),
                                        new Point(0.3686, 0.8081, 0.8081), new Point(0.4275, 1.0000, 1.0000),
                                        new Point(0.5216, 1.0000, 1.0000), new Point(0.6314, 0.7292, 0.7292),
                                        new Point(0.6863, 0.2796, 0.2796), new Point(0.7451, 0.0000, 0.0000),
                                        new Point(0.7922, 0.0000, 0.0000), new Point(0.8431, 0.1753, 0.1753),
                                        new Point(0.8980, 0.5000, 0.5000), new Point(1.0000, 0.9725, 0.9725)),
                        Arrays.asList(new Point(0.0, 0.5020, 0.5020), new Point(0.0510, 0.0222, 0.0222),
                                        new Point(0.1098, 1.0000, 1.0000), new Point(0.2039, 1.0000, 1.0000),
                                        new Point(0.2627, 0.6145, 0.6145), new Point(0.3216, 0.0000, 0.0000),
                                        new Point(0.4157, 0.0000, 0.0000), new Point(0.4745, 0.2342, 0.2342),
                                        new Point(0.5333, 0.0000, 0.0000), new Point(0.5804, 0.0000, 0.0000),
                                        new Point(0.6314, 0.0549, 0.0549), new Point(0.6902, 0.0000, 0.0000),
                                        new Point(0.7373, 0.0000, 0.0000), new Point(0.7922, 0.9738, 0.9738),
                                        new Point(0.8000, 1.0000, 1.0000), new Point(0.8431, 1.0000, 1.0000),
                                        new Point(0.8980, 0.9341, 0.9341), new Point(1.0000, 0.9961, 0.9961)));

        public static ColorMap gist_rainbow = new RGBPointListColorMap(
        ...
        public static ColorMap gist_stern = new ListColorMap(
                        Arrays.asList(new Point(0.000, 0.000, 0.000), new Point(0.0547, 1.000, 1.000),
                                        new Point(0.250, 0.027, 0.250), new Point(1.000, 1.000, 1.000)),
                        Arrays.asList(new Point(0, 0, 0), new Point(1, 1, 1)),
                        Arrays.asList(new Point(0.000, 0.000, 0.000), new Point(0.500, 1.000, 1.000),
                                        new Point(0.735, 0.000, 0.000), new Point(1.000, 1.000, 1.000)));

        private static double gist_yarg(double x) {
                return 1 - x;
        }

        public static ColorMap gist_yarg = new FunctionColorMap(ColorMaps::gist_yarg, ColorMaps::gist_yarg,
                        ColorMaps::gist_yarg);
         ...
         */
        public static ColorMap coolwarm = new ListColorMap(Arrays.asList(new Point(0.0, 0.2298057, 0.2298057),
                        new Point(0.03125, 0.26623388, 0.26623388), new Point(0.0625, 0.30386891, 0.30386891),
                        new Point(0.09375, 0.342804478, 0.342804478), new Point(0.125, 0.38301334, 0.38301334),
                        new Point(0.15625, 0.424369608, 0.424369608), new Point(0.1875, 0.46666708, 0.46666708),
                        new Point(0.21875, 0.509635204, 0.509635204), new Point(0.25, 0.552953156, 0.552953156),
                        new Point(0.28125, 0.596262162, 0.596262162), new Point(0.3125, 0.639176211, 0.639176211),
                        new Point(0.34375, 0.681291281, 0.681291281), new Point(0.375, 0.722193294, 0.722193294),
                        new Point(0.40625, 0.761464949, 0.761464949), new Point(0.4375, 0.798691636, 0.798691636),
                        new Point(0.46875, 0.833466556, 0.833466556), new Point(0.5, 0.865395197, 0.865395197),
                        new Point(0.53125, 0.897787179, 0.897787179), new Point(0.5625, 0.924127593, 0.924127593),
                        new Point(0.59375, 0.944468518, 0.944468518), new Point(0.625, 0.958852946, 0.958852946),
                        new Point(0.65625, 0.96732803, 0.96732803), new Point(0.6875, 0.969954137, 0.969954137),
                        new Point(0.71875, 0.966811177, 0.966811177), new Point(0.75, 0.958003065, 0.958003065),
                        new Point(0.78125, 0.943660866, 0.943660866), new Point(0.8125, 0.923944917, 0.923944917),
                                        new Point(0.625, 0.678007945, 0.678007945),
                                        new Point(0.65625, 0.628751763, 0.628751763),
                                        new Point(0.6875, 0.579375448, 0.579375448),
                                        new Point(0.71875, 0.530263762, 0.530263762),
                                        new Point(0.75, 0.481775914, 0.481775914),
                                        new Point(0.78125, 0.434243684, 0.434243684),
                                        new Point(0.8125, 0.387970225, 0.387970225),
                                        new Point(0.84375, 0.343229596, 0.343229596),
                                        new Point(0.875, 0.300267182, 0.300267182),
                                        new Point(0.90625, 0.259301199, 0.259301199),
                                        new Point(0.9375, 0.220525627, 0.220525627),
                                        new Point(0.96875, 0.184115123, 0.184115123),
                                        new Point(1.0, 0.150232812, 0.150232812)));
         ...
         */
        public static ColorMap CMRmap = new ListColorMap(Arrays.asList(new Point(0.000, 0.00, 0.00),
                        new Point(0.125, 0.15, 0.15), new Point(0.250, 0.30, 0.30), new Point(0.375, 0.60, 0.60),
                        new Point(0.500, 1.00, 1.00), new Point(0.625, 0.90, 0.90), new Point(0.750, 0.90, 0.90),
                        new Point(0.875, 0.90, 0.90), new Point(1.000, 1.00, 1.00)),
                        Arrays.asList(new Point(0.000, 0.00, 0.00), new Point(0.125, 0.15, 0.15),
                                        new Point(0.250, 0.15, 0.15), new Point(0.375, 0.20, 0.20),
                                        new Point(0.500, 0.25, 0.25), new Point(0.625, 0.50, 0.50),
                                        new Point(0.750, 0.75, 0.75), new Point(0.875, 0.90, 0.90),
                                        new Point(1.000, 1.00, 1.00)),
                        Arrays.asList(new Point(0.000, 0.00, 0.00), new Point(0.125, 0.50, 0.50),
                                        new Point(0.250, 0.75, 0.75), new Point(0.375, 0.50, 0.50),
                                        new Point(0.500, 0.15, 0.15), new Point(0.625, 0.00, 0.00),
                                        new Point(0.750, 0.10, 0.10), new Point(0.875, 0.50, 0.50),
                                        new Point(1.000, 1.00, 1.00)));
        /*
         ...
         */
        public static ColorMap wistia = new ListColorMap(
                        Arrays.asList(new Point(0.0, 0.8941176470588236, 0.8941176470588236), new Point(0.25, 1.0, 1.0),
                                        new Point(0.5, 1.0, 1.0), new Point(0.75, 1.0, 1.0),
                                        new Point(1.0, 0.9882352941176471, 0.9882352941176471)),
                        Arrays.asList(new Point(0.0, 1.0, 1.0), new Point(0.25, 0.9098039215686274, 0.9098039215686274),
                                        new Point(0.5, 0.7411764705882353, 0.7411764705882353),
                                        new Point(0.75, 0.6274509803921569, 0.6274509803921569),
                                        new Point(1.0, 0.4980392156862745, 0.4980392156862745)),
                        Arrays.asList(new Point(0.0, 0.47843137254901963, 0.47843137254901963),
                                        new Point(0.25, 0.10196078431372549, 0.10196078431372549),
                                        new Point(0.5, 0.0, 0.0), new Point(0.75, 0.0, 0.0), new Point(1.0, 0.0, 0.0)));
        ...
        public static ColorMap tab10 = new ColorListColorMap(
        ...
        public static ColorMap tab20 = new ColorListColorMap(
                        Arrays.asList(new Color(0.12156862745098039, 0.4666666666666667, 0.7058823529411765, 1.0), // 1f77b4
        ...
        public static ColorMap tab20b = new ColorListColorMap(
        ...
        public static ColorMap tab20c = new ColorListColorMap(
